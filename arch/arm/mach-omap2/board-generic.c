...
static const char *densodra75xref_boards_compat[] __initconst = {
	"denso,dra75xref",
	NULL,
};

DT_MACHINE_START(DENSODRA75XREF_DT, "hrbj6")
	.reserve	= omap_reserve,
	.smp		= smp_ops(omap4_smp_ops),
	.map_io		= omap5_map_io,
	.init_early	= dra7xx_init_early,
	...
	.init_machine	= omap_generic_init,
	.init_time	= omap5_realtime_timer_init,
	.dt_compat	= densodra75xref_boards_compat,
	.restart	= omap44xx_restart,
MACHINE_END


static const char *densodra74xmid_boards_compat[] __initconst = {
	"denso,dra74xmid",
	NULL,
};

DT_MACHINE_START(DENSODRA74XMID_DT, "DENSO 74x mid")
	...
	.init_machine	= omap_generic_init,
	.init_time	= omap5_realtime_timer_init,
	.dt_compat	= densodra74xmid_boards_compat,
	.restart	= omap44xx_restart,
MACHINE_END

static const char *densodra74xlow_boards_compat[] __initconst = {
	"denso,dra74xlow",
	NULL,
};

DT_MACHINE_START(DENSODRA74XLOW_DT, "DENSO 74x low")
#if defined(CONFIG_ZONE_DMA) && defined(CONFIG_ARM_LPAE)
       .dma_zone_size  = SZ_2G,
#endif
	.reserve	= omap_reserve,
	...
	.init_machine	= omap_generic_init,
	.init_time	= omap5_realtime_timer_init,
	.dt_compat	= densodra74xlow_boards_compat,
	.restart	= omap44xx_restart,
MACHINE_END

static const char *densodra72xlow_boards_compat[] __initconst = {
	"denso,dra72xlow",
	NULL,
};

DT_MACHINE_START(DENSODRA72XLOW_DT, "DENSO 72x low")
	.reserve	= omap_reserve,
	.map_io		= omap5_map_io,
	.init_early	= dra7xx_init_early,
	.init_late	= dra7xx_init_late,
	...
	.init_machine	= omap_generic_init,
	.init_time	= omap5_realtime_timer_init,
	.dt_compat	= densodra72xlow_boards_compat,
	.restart	= omap44xx_restart,
MACHINE_END
