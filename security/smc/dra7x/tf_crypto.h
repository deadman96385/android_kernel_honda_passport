...
int tf_crypto_hmac_module_init(void);
void tf_crypto_hmac_module_exit(void);

int tf_self_test_register_device(void);
void tf_self_test_unregister_device(void);
...
int tf_crypto_rng_init(void);
void tf_crypto_rng_exit(void);

#endif /* CONFIG_TF_CRYPTO_RNG */
