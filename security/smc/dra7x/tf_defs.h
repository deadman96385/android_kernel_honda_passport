...
struct tf_connection {
	...
	struct page *pages_table[TF_DESCRIPTOR_TABLE_CAPACITY_LPAE];
#else
	struct page *pages_table[TF_DESCRIPTOR_TABLE_CAPACITY];
#endif
...
extern struct omap_secure_platform_data *pdata;
