...
#define tf_ion_device omap_ion_device
#endif
...
static inline int tf_is_omap5_es2(void)
{
	unsigned int rev = omap_rev();
	return ((rev == OMAP5430_REV_ES2_0) || (rev == OMAP5432_REV_ES2_0) ||
		(rev == DRA752_REV_ES1_0) || (rev == DRA752_REV_ES1_1) ||
		(rev == DRA722_REV_ES1_0));
}

int tf_early_init(void);

int tf_device_mshield_init(void);
